        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-2 md:gap-3">
          {instagramImages.map((img, index) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gold-500/0 group-hover:bg-gold-500/20 transition-colors duration-300 flex items-center justify-center">
                <svg
        ...
        >
          ...
          >
            <motion.span
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 text-white font-semibold uppercase tracking-widest text-sm rounded-sm cursor-pointer"
            >
