...
export default function Footer() {
  return (
    <footer className="bg-dark-600 border-t border-gold-500/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            >
              <h3 className="text-3xl font-serif font-bold">
                ...
                <span className="text-white/80 text-xl font-light ml-1">
                  by Geetika
                </span>
              </h3>
            </motion.div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 rounded-full border border-gold-500/30 flex items-center justify-center text-gold-400 hover:bg-gold-500/10 transition-all"
          ...
          {/* Shop Links */}
          <div>
            <h4 className="text-gold-400 uppercase tracking-widest text-sm font-semibold mb-6">
              Shop
            </h4>
        ...
        {/* Bottom Bar */}
        <div className="mt-16 pt-8 border-t border-gold-500/10 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-white/30 text-sm">
            &copy; {new Date().getFullYear()} Jewels by Geetika. All rights reserved.
          </p>
          <p className="text-white/30 text-sm">
