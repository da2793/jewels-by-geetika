...
const footerLinks = {
  ...
  company: [
    ...
    { label: "Shipping & Payment Policy", href: "/policies" },
  ],
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-3">
              ...
              <a
                href="https://wa.me/919289890426"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/60 hover:bg-green-500 hover:text-white transition-all duration-300"
                aria-label="WhatsApp"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Shop Links */}
          <div>
            <h4 className="text-white/80 uppercase tracking-[0.2em] text-[11px] font-medium mb-6">
              Shop
            </h4>
            <ul className="space-y-3">
              {footerLinks.shop.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-white/40 hover:text-gold-400 transition-colors text-sm font-light"
                  >
                    {link.label}
                  </Link>
                </li>
