          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-cream-300">
              <h2 className="font-serif text-xl text-charcoal-800">
                Your Bag{" "}
                <span className="text-charcoal-300 text-sm font-sans font-light">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4">
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-charcoal-400 font-light mb-2">Your bag is empty</p>
                  <p className="text-charcoal-300 text-sm font-light mb-6">
            ...
            {items.length > 0 && (
              <div className="border-t border-cream-300 px-6 py-5 space-y-4">
                ...
                <p className="text-charcoal-300 text-xs font-light">
                ...
                <button
                  onClick={closeCart}
                  className="block w-full text-center text-charcoal-400 text-sm font-light hover:text-gold-600 transition-colors"
                >
                  Continue Shopping
                </button>
              </div>
