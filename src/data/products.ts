...
export const products: Product[] = [
  {
    ...
    originalPrice: 3499,
    description:
      "A stunning kundan choker set featuring intricate meenakari work on the reverse. This hand-curated piece combines traditional craftsmanship with modern elegance.",
    details: [
      "Material: High-quality AD stones with gold plating",
      "Finish: Antique gold with meenakari",
  ...
  },
  {
    ...
    originalPrice: 1299,
    description:
      "Elegant pearl drop jhumkas with delicate filigree work. These lightweight earrings are perfect for both festive occasions and everyday glamour.",
    details: [
      "Material: Pearl beads with gold-plated brass",
      "Weight: Lightweight (approx 12g per piece)",
      "Closure: Push-back with silicone stoppers",
      "Length: 3.5 cm drop",
    ],
    images: [
